...
const CustomLineChartIncome = ({ data }) => {
            ...
            return (
                <div className="bg-white shadow-lg rounded-xl p-4 border border-gray-200">
                    ...
                    <p className="text-sm text-gray-700 font-bold mb-3">
                        Total: <span className="text-green-600">&#8377;{addThousandsSeparator(dataPoint.totalAmount)}</span>
                    </p>
                        ...
                        <div className="mt-2 pt-2 border-t border-gray-200">
                            ...
                            {categoriesInTooltip.map((groupedItem, index) => (
                                <div key={index} className="flex justify-between text-xs text-gray-700 py-1">
                                    ...
                                    <span className="text-green-600 font-semibold">&#8377;{addThousandsSeparator(groupedItem.totalAmount)}</span>
                                </div>
                            ))}
                        </div>
                    )}
                ...
                <AreaChart data={data}>
                    <defs>
                        <linearGradient id="expenseGradient" x1="0" y1="0" x2="0" y2="1">
                            <stop offset="5%" stopColor="#0D6C0BFF" stopOpacity={0.5} />
                            <stop offset="95%" stopColor="#0D6C0BFF" stopOpacity={0.05} />
                        </linearGradient>
                    </defs>
                    ...
                    <YAxis
                        ...
                        axisLine={false}
                    />
                    <Tooltip content={<CustomTooltip/>} cursor={{ stroke: '#0D6C0BFF', strokeWidth: 1, strokeDasharray: '5 5' }} />
                    ...
                    <Area
                        ...
                        strokeWidth={3}
                        dot={{ r: 4, fill: "#0a8019", strokeWidth: 2, stroke: "#fff" }}
                        activeDot={{ r: 6, fill: "#0d6c0b", strokeWidth: 2, stroke: "#fff" }}
                    />
                </AreaChart>
            </ResponsiveContainer>
        </div>
...
export default CustomLineChartIncome;